 ...
 */
package br.com.pinhoinformatica.reinf.controller;

import br.com.pinhoinformatica.bridge.controller.util.EmpBaseUserProfileUtil;
import com.powerlogic.jcompany.commons.config.qualifiers.QPlcDefault;
import com.powerlogic.jcompany.commons.config.stereotypes.SPlcUtil;

/**
 * efdReinf . Implementar aqui lógicas de perfil do usuário
 * da aplicação (user profiling)
 */
@SPlcUtil
@QPlcDefault
public class AppUserProfileUtil extends EmpBaseUserProfileUtil {
