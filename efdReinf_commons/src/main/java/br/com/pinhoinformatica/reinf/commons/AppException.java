 ...
 */
package br.com.pinhoinformatica.reinf.commons;

import br.com.pinhoinformatica.bridge.commons.EmpException;

/**
 * efdReinf. Implementar aqui tratamento de exceções específicas da Aplicação
 */
public class AppException extends EmpException {
	/**
	 *
	 */
